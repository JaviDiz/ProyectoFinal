...
<html>
    ...
    <body>
        ...
        <form name="frm-game" action="${pageContext.request.contextPath}/game" method="POST" class="was-validated">
           ...
           <input type="hidden" name="idGame" value="${game.id}" />
        	...
        	<section id="actions" class="py-4 mb-4 bg-light">
			    <div class="container">
			        <div class="row">
			            <div class="col-md-3">
			                <a href="frmGame.jsp" class="btn btn-ligth btn-block">
			                    <i class="fas fa-arrow-left"></i> Regresar a la lista
			                </a>
			            </div>
			            <div class="col-md-3">
			                <button type="submit" class="btn btn-success btn-block">
			                    <i class="fas fa-check"></i> Guardar Juego
			                </button>
			            </div>
			            <div class="col-md-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="description" required value="${game.description}">
                                    </div>
                                    <div class="form-group">
                                        <label for="cover">Cover</label>
                                        <input type="text" class="form-control" name="cover" required value="${game.cover}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" name="saldo" required value="${game.balance}" step="any">
                                    </div>
                                    <div class="form-group">
                                        <label for="pegi">Pegi</label>
                                        <input type="number" class="form-control" name="pegi" required value="${game.pegi}" step="any">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
        	...
        	btnDelete.onclick = function(){
        		...
        		document.forms["frm-game"].submit();
        	}
