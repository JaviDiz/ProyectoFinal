...
if(!usuari.isAdmin()){
	response.sendRedirect("/store/frmGameClient.jsp");
}
...
<html lang="es">
    ...
    <body>
		        ...
		        <div class="row">
		            ...
		            <div class="col-md-3 mt-2">
		                <a href="#" class="btn btn-dark btn-block"
		                   data-toggle="modal" data-target="#agregarSkinModal">
		                    <i class="fas fa-plus"></i> Agregar Skin
		                </a>
		            </div>
		            <div class="col-md-3 mt-2">
        ...
        <!--Listado Clientes --> 
        <jsp:include page="/listSkins.jsp"/>
        
        <!-- Agregar cliente MODAL -->
		<jsp:include page="/addSkin.jsp"/>
